...
const CHANGELOG = [
  ...
  { version: "0.2.0", date: "TBD — Week 2", type: "planned", label: "Foundation", changes: ["Monorepo Turborepo + pnpm workspaces", "Supabase schema lengkap + RLS policy semua tabel", "Auth: email + Google SSO", "Elysia + Bun server di Railway (health, CORS)", "Next.js 15 App Router di Vercel", "CI/CD: GitHub Actions (typecheck + lint + deploy)", "Seed data: CP Kurikulum Merdeka + CurriculumVersion"] },
  { version: "0.3.0", date: "TBD — Week 5", type: "planned", label: "Core Editor", changes: ["Auth pages + onboarding wizard", "Dashboard guru + daftar modul + filter/search", "Dynamic form renderer dari ModuleTemplate.schema", "Scratch editor Tiptap + autosave", "Curated library: FTS search + fork", "Module status flow"] },
...
const C = { planning: { color: "#818CF8", bg: "#1E1B4B", label: "Decision" }, planned: { color: "#475569", bg: "#1E293B", label: "Planned" }, done: { color: "#10B981", bg: "#0A2918", label: "Released" } };
